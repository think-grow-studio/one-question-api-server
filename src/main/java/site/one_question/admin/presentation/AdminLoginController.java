package site.one_question.admin.presentation;
...
import site.one_question.admin.application.AdminApplication;
...
public class AdminLoginController {
    ...
    public String dashboard(
        ...
        model.addAttribute("historyByDate", adminApplication.getAiPersonaHistory(startDate, endDate));
